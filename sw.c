...
int main(int argc, char * argv[]){
  ...
  char rails_usernotfound[240];
  char rails_accessdenied[240];

  snprintf(rails_usernotfound, sizeof rails_usernotfound, "http://%.200s:%d/usernotfound", rails_hostname, rails_port);
  snprintf(rails_accessdenied, sizeof rails_accessdenied, "http://%.200s:%d/denied", rails_hostname, rails_port);
